...
ccin = "4390930037967492|10|2026|212"
...
def run(ccin):
    try:
        ...
        code, decline_code, message = checkout(cc, "000", mes, ano, seti, setik)
        print(code, decline_code, message)

        return {
            "mb_copy": f"{code} | {decline_code}" if code else "",
